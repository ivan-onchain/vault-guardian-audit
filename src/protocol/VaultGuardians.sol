...
contract VaultGuardians is Ownable, VaultGuardiansBase {
    ...
    function updateGuardianAndDaoCut(uint256 newCut) external onlyOwner {
        ...
        // Info: Event doesn't reflect the action.
     ...
     */
    // q anybody can call this function? so anybody can sweep the asset balance to the owner?
    // low: This function should be restricted by onlyOwner to avoid miss handling.
